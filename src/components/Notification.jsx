...
const Notification = ({ show, setShow, title, children }) => {
  return (
          ...
          <div className="rounded-lg shadow-xs overflow-hidden">
            <div className="p-4">
              <div className="flex items-start">
                ...
                <div className="ml-3 w-0 flex-1 pt-0.5 justify-start">
                ...
                <div className="ml-4 flex-shrink-0 flex">
                  <button
                    data-todo-at-click="show = false; setTimeout(() => show = true, 1000)"
